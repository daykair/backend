module.exports = (config, { strapi }) => {
  return async (ctx, next) => {
    const allowedOrigins = ['https://front-saodi.vercel.app', 'http://localhost:3000', 'http://localhost:4321', 'http://127.0.0.1:4321', 'https://saodi.store/', 'https://www.saodi.store/', 'https://backend-production-8f9a.up.railway.app'];
